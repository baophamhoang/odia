    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-background">
      ...
      >
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-xl bg-accent px-4 py-3 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-accent-hover focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2"
        >
          <GoogleIcon />
          Sign in with Google
        </button>
